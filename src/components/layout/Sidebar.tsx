...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: '🔍',
    items: [
      { id: 'radar', icon: '🕵️‍♂️', label: 'Radar คู่แข่ง', color: '#10b981', featured: true },
      { id: 'news', icon: '🔎', label: 'ค้นหา Content', color: '#ef4444', featured: true },
    ],
  },
  {
    label: '2 คลัง Content',
    icon: '📦',
    items: [
      { id: 'articlestock', icon: '📚', label: 'คลัง Content', color: '#06b6d4', featured: true },
    ],
  },
  {
    label: '3 สร้าง Content',
    icon: '✨',
    items: [
  ...
  {
    label: '4 โคลนสมอง / Prompt Lab',
    icon: '🧠',
    items: [
      { id: 'clone', icon: '🖼️', label: 'โคลนสไตล์/สมองเพจ', color: '#f59e0b', featured: true },
      { id: 'prompt', icon: '📝', label: 'Video Prompt Lab', color: '#f43f5e' },
      { id: 'storyarchitect', icon: '📚', label: 'AI Storyboard', color: '#4f46e5', featured: true },
    ],
  },
  {
    label: '5 ตัดต่อวิดีโอ',
    icon: '🎬',
    items: [
      { id: 'singleclip', icon: '✂️', label: 'ตัด/สุ่มต่อคลิป', color: '#6366f1', featured: true },
      { id: 'stockclip', icon: '🎞️', label: 'คลิป Stock จากเสียง', color: '#14b8a6', featured: true },
      { id: 'autoeditor', icon: '🎬', label: 'AI รวมคลิปเป็นเรื่อง', color: '#eab308' },
      { id: 'financial', icon: '🎙️', label: 'Documentary Studio', color: '#f97316' },
      { id: 'bulk', icon: '📹', label: 'Bulk เก่า (Legacy)', color: '#3b82f6' },
    ],
  },
  {
    label: '6 API & Integrations',
    icon: '🔑',
    items: [
      { id: 'fbtoken', icon: '🔵', label: 'Facebook Token', color: '#1877f2', featured: true },
  ...
  },
  {
    ...
    icon: '⚙️',
    items: [
      { id: 'assets', icon: '📂', label: 'คลัง Assets', color: '#8b5cf6' },
